...
@Config
@Autonomous(name = "SparkfunTestAuto", group = "Purple Pixel Autos")
public class SparkfunTestAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException{
        ...
        while (opModeIsActive()) {
           ...
           /* if (pos.y>-72) {
                ...
                backLeftMotor.setPower(.7*0.57);
                frontRightMotor.setPower(.7*0.57);
    ...
    private void lineForward ( double dis) {
        lineDone = false;
        SparkFunOTOS myOtos;
        ...
        if (pos.y>-dis) {
            ...
            backLeftMotor.setPower(.5*0.57);
            frontRightMotor.setPower(.5*0.57);
